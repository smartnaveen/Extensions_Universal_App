...
/*
 ...
 2. Have Two Option 1. Use Pod file 2. Use Manually
 3. Call function Inside controller in both case same.
 4. Call function to Show Toast  ------
 
 self.view.makeToast("UnAuthorize")
 For More About reads Github resources of these pod features more customisable
